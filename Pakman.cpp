...
int main() {
    ...
    Texture t;
    t.loadFromFile("C:/Users/Gilyana/source/repos/Project2/Project2/mitle.png");
    Sprite plat(t);

    Texture yw;
    yw.loadFromFile("C:/Users/Gilyana/source/repos/Project2/Project2/youwin.png");
    Sprite youwin(yw);
    youwin.setPosition(100, 210);

    Texture yl;
    yl.loadFromFile("C:/Users/Gilyana/source/repos/Project2/Project2/youlose.png");
    Sprite youlose(yl);
